    ...
    <header class="max-w-screen-xl pb-6 mx-auto mb-8 border-b-2 border-gray-400 border-dashed">
        <nav class="container flex justify-between max-w-screen-xl mx-auto  text-slate-600">
            <ul class="flex gap-6 py-3">
                ...
                <li>
                    <a href='<?= site()->linkedin() ?>' target="_blank" class="flex items-center gap-1 group hover:text-slate-900 focus:outline-dashed outline-1 outline-offset-2">
                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill="none" d="M0 0h24v24H0z" />
                ...
                <li>
                    <a href="mailto:<?= site()->email() ?>" class="flex items-center gap-1 group hover:text-slate-900 focus:outline-dashed outline-1 outline-offset-2">
            ...
            <ul class="flex gap-4 py-3 text-sm">
                <li class="flex">
                    <a href='/en' class="flex items-center gap-1 group hover:text-slate-900 focus:outline-dashed outline-1 outline-offset-2">
                        <svg class="w-4 h-4 stroke-2 stroke-slate-600 group-hover:stroke-slate-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true">
