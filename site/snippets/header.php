...
<body>
    <header class="max-w-screen-lg mx-auto mb-8">
        <nav class="container flex flex-wrap items-center justify-center max-w-screen-lg gap-2 px-4 mx-auto my-3 text-sm text-zinc-100 lg:p-0 md:justify-between">
            <ol class="flex flex-wrap gap-x-6 gap-y-2">
                <li>
                    <a href='<?= site()->github() ?>' target="_blank" class="flex items-center gap-1 group hover:text-zinc-400 focus:outline-dashed outline-1 outline-offset-2">
                        <svg class="w-4 h-4 fill-zinc-100 group-hover:fill-zinc-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <li>
                    <a href='<?= site()->linkedin() ?>' target="_blank" class="flex items-center gap-1 group hover:text-zinc-400 focus:outline-dashed outline-1 outline-offset-2">
                        <svg class="w-4 h-4 fill-zinc-100 group-hover:fill-zinc-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill="none" d="M0 0h24v24H0z" />
                ...
                <li>
                    <a href="mailto:<?= site()->email() ?>  " class="flex items-center gap-1 group hover:text-zinc-400 focus:outline-dashed outline-1 outline-offset-2">
                        <svg class="w-4 h-4 stroke-2 stroke-zinc-100 group-hover:stroke-zinc-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
