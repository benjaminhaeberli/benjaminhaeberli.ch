...
<body>
    <header class="fixed z-50 w-full mb-8 border-b-2 bg-zinc-950 border-zinc-800">
        <div class="max-w-screen-lg mx-auto">
            <nav class="container flex flex-wrap items-center justify-center max-w-screen-lg gap-2 mx-auto my-3 text-sm lg:p-0 md:justify-between">
