...
?>
<footer class="container flex flex-col items-center justify-between max-w-screen-lg mx-auto mt-32 mb-8 text-sm">
    ...
    <div class="flex flex-wrap items-center justify-center gap-2 mx-auto my-3 text-sm md:justify-between">
    ...
    <div class="flex gap-2">
        <div class="w-4 h-4 bg-gradient-to-r from-sky-500 to-indigo-500 hover:from-pink-500 hover:to-yellow-500 rounded-2xl"></div>
