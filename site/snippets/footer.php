...
?>
<footer class="container flex items-center justify-between max-w-screen-lg py-8 mx-auto text-sm border-t-2 border-zinc-800 border-dashed">
    <nav class="fixed left-8 bottom-6">
        <a href="#" class="bh__svg-up">Haut de page</a>
    </nav>
    <div class="flex flex-col max-w-sm gap-2 border-dashed border-zinc-600">
        <p><span class="px-2 py-1 rounded-full bg-zinc-900 ring-1 ring-inset ring-primary/20">0.02 g of CO<sub>2</sub>/view</span></p>
