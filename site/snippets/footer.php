...
?>
<footer class="container flex flex-col items-center justify-between max-w-screen-lg py-8 mx-auto text-sm border-t-2 border-red-400">
    ...
    <div class="flex gap-2">
        <div class="w-4 h-4 bg-orange-400 rounded-2xl"></div>
