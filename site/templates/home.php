        ...
        <div class="flex flex-col gap-12">
            ...
            <div class="grid max-w-screen-xl grid-cols-2 gap-4 md:grid-cols-3">
                <details class="flex flex-col gap-1 group">
                    <summary class="font-bold list-none border-2 p-4 border-dashed flex items-center flex-col cursor-pointer group-open:bg-zinc-400/[.01] group-open:border-primary hover:border-primary border-zinc-600 text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 mb-4 text-primary">
                ...
                <details class="flex flex-col gap-1 group">
                    <summary class="font-bold list-none border-2 p-4 flex items-center flex-col border-dashed cursor-pointer group-open:bg-zinc-400/[.01] group-open:border-primary hover:border-primary border-zinc-600 text-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 mb-4 text-primary">
